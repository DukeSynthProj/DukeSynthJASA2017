...
if(sum((bs_synthetic_instrctpgm[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0)
{
  print("Error: More zeros in synthetic_instrctpgm")
  print(which(((bs_synthetic_instrctpgm[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0))
  break()
}
...
if(sum((bs_synthetic_occ_cat[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0)
{
  print("Error: More zeros in synthetic_occ_cat")
  print(which(((bs_synthetic_occ_cat[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0))
  break()
}
...
if(sum((bs_synthetic_funcclas[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0)
{
  print("Error: More zeros in synthetic_funcclas")
  print(which(((bs_synthetic_funcclas[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0))
  break()
}
...
if(sum((bs_synthetic_flsa[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0)
{
  print("Error: More zeros in synthetic_flsa")
  print(which(((bs_synthetic_flsa[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0))
  break()
}
...
if(sum((bs_synthetic_appttype[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0)
{
  print("Error: More zeros in synthetic_appttype")
  print(which(((bs_synthetic_appttype[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0))
  break()
}
...
if(sum((bs_synthetic_polappttype[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0)
{
  print("Error: More zeros in synthetic_polappttype")
  print(which(((bs_synthetic_polappttype[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0))
  break()
}
...
if(sum((bs_synthetic_position[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0)
{
  print("Error: More zeros in synthetic_position")
  print(which(((bs_synthetic_position[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0))
  break()
}
...
if(sum((bs_synthetic_tenure[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0)
{
  print("Error: More zeros in synthetic_tenure")
  print(which(((bs_synthetic_tenure[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0))
  break()
}
...
if(sum((bs_synthetic_svsrstat[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0)
{
  print("Error: More zeros in synthetic_svsrstat")
  print(which(((bs_synthetic_svsrstat[,J1]=="0") - (bs_synthetic_agency[,J1] == "0"))>0))
  break()
}
...
sum((bs_synthetic_instrctpgm=="0") - (bs_synthetic_agency == "0"))
sum((bs_synthetic_occ_cat=="0") - (bs_synthetic_agency == "0"))
sum((bs_synthetic_funcclas=="0") - (bs_synthetic_agency == "0"))
sum((bs_synthetic_flsa=="0") - (bs_synthetic_agency == "0"))
sum((bs_synthetic_appttype=="0") - (bs_synthetic_agency == "0"))
sum((bs_synthetic_polappttype=="0") - (bs_synthetic_agency == "0"))
sum((bs_synthetic_position=="0") - (bs_synthetic_agency == "0"))
sum((bs_synthetic_tenure=="0") - (bs_synthetic_agency == "0"))
sum((bs_synthetic_svsrstat=="0") - (bs_synthetic_agency == "0"))
