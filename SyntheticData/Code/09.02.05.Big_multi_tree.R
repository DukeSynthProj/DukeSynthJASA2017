...
for(J2 in 1:length(multi_tree))
{
  ...
  if(is.null(data_tmp$Tr)==FALSE)
  {
    ...
    print("############");print("############")
    print(paste("START Big multi_tree -- J2",J2,"of",sum(freq_multi_tree>=BIG),"Sample Size",nrow(X_O),
    ...
    #    if(J2==1)        
    print(paste("ENDS Big multi_tree -- J2",J2,"of",sum(freq_multi_tree>=BIG)))
    
    if(J2%%100==0 & length(multi_tree)<=2000)        
      print(paste("multi_tree -- J2",J2,"of",sum(freq_multi_tree>=BIG)))
