...
data_general = data_general[data_general$init_agency!="0",]
data_synthetic_general = data_synthetic_general[data_synthetic_general$init_agency!="0",]
...
f<-function(j)
{
  ...
  print(paste("mono_multi_table -- j",j,"of",nrow(Index)))
...
mono = mono[mono %in% data_synthetic_general$collapse]
mono_tree = mono_tree[mono_tree %in% data_synthetic_general$collapse]
multi_tree = multi_tree[multi_tree %in% data_synthetic_general$collapse]
