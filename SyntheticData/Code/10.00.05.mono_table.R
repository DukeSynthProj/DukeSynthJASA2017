...
if(length(mono)>0)
{
  print(paste("mono_table -- Year",J1,length(mono),"of total collapse", length(unique(data_general$collapse))))
...
{    
  ...
  {
    if(j==1)        
      print(paste("Pre - mono_table -- Year",J1," - J",j,"of",length(mono)))  
  ...
  {
    if(j==1)        
      print(paste("Pre - mono_table -- Year",J1," - J",j,"of",length(unique_mono_table)))
 ...
 for(j in 1:length(unique_mono_table))
{
  ...
  {
    if(j==1)        
      print(paste("mono_table -- Year",J1," - J",j,"of",nrow(mono_table)))  
