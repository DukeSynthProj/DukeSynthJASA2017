...
1) Create two folders named Aux_Files and Synthetic_Files.

2) Split OPM dataset into 29 RData files. Each file comprises the 
...
3) Specify the right paths in each of the R script files in the Code 
folder.

4)  Open Terminal and execute the commands in Code/00.Commands.txt
